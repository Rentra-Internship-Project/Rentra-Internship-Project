...
import { mockAdminProfile as initialProfile } from '../../data/adminMockData';
    ...
    >
      ...
      <div>
        <h3 className="text-sm font-bold uppercase tracking-wider text-[#64748B] mb-4">
          Administrator Performance Statistics
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          <StatsCard
            title="Businesses Approved"
            value={profile.stats.businessesApproved}
            icon={FiBriefcase}
          ...
          <StatsCard
            ...
            value={profile.stats.equipmentApproved}
            icon={FiTruck}
          ...
          <StatsCard
            ...
            value={profile.stats.categoriesCreated}
            icon={FiLayers}
          ...
          <StatsCard
            ...
            value={profile.stats.totalActionsPerformed.toLocaleString()}
            icon={FiZap}
            accentBg="bg-blue-50"
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-[20px] p-4 md:p-6 shadow-xs">
            <div className="flex items-center gap-3 pb-4 border-b border-[#E2E8F0] mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-[#64748B]">Update your administrative contact and bio details.</p>
              </div>
            </div>
            ...
            <form onSubmit={handleUpdateInfo} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-[#0F172A] mb-1">Administrator Bio</label>
                <textarea
                  rows="3"
                  value={bio}
          ...
          <div className="bg-white border border-[#E2E8F0] rounded-[20px] p-4 md:p-6 shadow-xs">
            <div className="flex items-center gap-3 pb-4 border-b border-[#E2E8F0] mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-[#64748B]">Update your administrative password.</p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div className="bg-white border border-[#E2E8F0] rounded-[20px] p-4 md:p-6 shadow-xs">
            <div className="flex items-center gap-3 pb-4 border-b border-[#E2E8F0] mb-4">
              ...
              <div>
                <h3 className="text-base font-bold text-[#0F172A]">Recent Admin Actions</h3>
                <p className="text-xs text-[#64748B]">Audit log of your recent operations</p>
              </div>
            </div>

            <div className="space-y-3">
              {profile.recentActions.map((act) => (
                <div
                  key={act.id}
