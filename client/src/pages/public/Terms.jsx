...
const Terms = () => {
  useDocumentTitle('Terms and Conditions', 'Review Rentra marketplace terms and conditions governing industrial machinery leasing, escrow deposits, cancellations, and disputes.');
