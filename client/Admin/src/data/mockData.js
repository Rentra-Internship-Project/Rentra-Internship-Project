...
export const mockNotifications = [
  {
    ...
    message: "Titan Heavy Rentals Inc. submitted documents for identity verification.",
    time: "10m ago",
    read: false,
    type: "business",
  ...
  {
    id: 2,
    title: "Equipment Listing Pending Review",
    message: "Caterpillar 320 Hydraulic Excavator was submitted for listing approval.",
    time: "25m ago",
    read: false,
    type: "equipment",
  ...
  },
  {
    ...
    message: "David Miller created a new marketplace account.",
    time: "1h ago",
    read: false,
    type: "user",
    link: "/admin/users"
  },
  {
    ...
    message: "Booking #RNT-9081 for Caterpillar Excavator confirmed by customer.",
    time: "2h ago",
    read: true,
    type: "booking",
    link: "/admin/bookings"
  },
  {
    ...
    message: "Volta Power Systems account successfully verified by Admin.",
    time: "4h ago",
    read: true,
    type: "business",
    link: "/admin/businesses"
