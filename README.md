...
- **Ayush Bhor (Frontend Engineer — Customer Portal):** Engineered the Customer Portal UI, catalog search with real-time filters, equipment details view, checkout deposit flows, dynamic PDF invoice generation, and wishlist management.
- **Pruthviraj Bhosale (Frontend Engineer — Admin Portal):** Engineered the Admin Control Center UI, high-level operational dashboards, user management with ban triggers, business verification workflows, category taxonomy management, and escrow monitoring.
